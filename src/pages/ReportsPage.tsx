            ...
            <CardBody>
              <div className="flex items-start justify-between mb-2">
                <div className="w-10 h-10 rounded-md bg-navy-50 flex items-center justify-center">
                  <FileBarChart className="w-5 h-5 text-navy-700" />
                </div>
                <span className={cn(
                  'badge text-[9px]',
              ...
              <div className="flex items-center justify-between mt-3 pt-3 border-t border-slate-50">
                ...
                <button
                  className="text-[12px] text-navy-600 hover:text-navy-800 font-medium flex items-center gap-1"
      ...
      >
        <div className="space-y-5">
          ...
          <div className="text-center pb-4 border-b border-slate-200">
            <div className="text-[18px] font-bold text-navy-900 tracking-tight">AARAMBHA</div>
            <div className="text-[12px] text-slate-500 mt-0.5">Investigation Brief</div>
            <div className="flex items-center justify-center gap-4 mt-3 text-[12px] text-slate-600">
              <span>Case: <strong className="text-slate-900">{demoInvestigationCase.id}</strong></span>
              <span>Risk: <strong className="text-red-600">{demoInvestigationCase.riskScore}/100</strong></span>
          ...
          {/* Executive Summary */}
          <div>
            <h4 className="text-[13px] font-semibold text-slate-900 mb-1.5">Executive Summary</h4>
          ...
          {/* Risk Signals */}
          <div>
            <h4 className="text-[13px] font-semibold text-slate-900 mb-2">Risk Signals</h4>
            <div className="space-y-1.5">
              {demoRiskAssessment.signals.map((s) => (
                <div key={s.id} className="flex items-center justify-between p-2 bg-slate-50 rounded text-[12px]">
                  <span className="font-medium text-slate-700">{s.label}</span>
                  <div className="flex items-center gap-3">
                    <span className="text-slate-500">{s.finding}</span>
          ...
          {/* Evidence Summary */}
          <div>
            <h4 className="text-[13px] font-semibold text-slate-900 mb-2">Evidence Summary</h4>
            <div className="grid grid-cols-3 gap-2 text-[12px]">
              <div className="p-2 bg-slate-50 rounded">
                <div className="text-[10px] text-slate-400 uppercase">Price Deviation</div>
                <div className="font-bold text-orange-600">+45.5%</div>
              </div>
              <div className="p-2 bg-slate-50 rounded">
                <div className="text-[10px] text-slate-400 uppercase">Bid Spread</div>
                <div className="font-bold text-orange-600">2.4% vs 6.8%</div>
              </div>
              <div className="p-2 bg-slate-50 rounded">
                <div className="text-[10px] text-slate-400 uppercase">Delay Rate</div>
                <div className="font-bold text-orange-600">23.8% vs 9.4%</div>
              </div>
            </div>
          </div>
          ...
          {/* Contractor History */}
          <div>
            <h4 className="text-[13px] font-semibold text-slate-900 mb-2">Contractor History</h4>
          ...
          {/* Bid Analysis */}
          <div>
            <h4 className="text-[13px] font-semibold text-slate-900 mb-2">Bid Analysis</h4>
            <p className="text-[12px] text-slate-600">
          ...
          {/* Financial Analysis */}
          <div>
            <h4 className="text-[13px] font-semibold text-slate-900 mb-2">Financial Analysis</h4>
            <p className="text-[12px] text-slate-600">
          ...
          <div>
            <h4 className="text-[13px] font-semibold text-slate-900 mb-2">Recommended Verification</h4>
          ...
          {/* Disclaimer */}
          <div className="p-3 bg-slate-50 border border-slate-200 rounded text-[11px] text-slate-500 italic">
